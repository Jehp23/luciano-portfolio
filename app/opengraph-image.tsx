...
export const alt = "Luciano Lazarte · Full Stack Developer";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const META = [
  { label: "ROL", val: "FULL STACK" },
  { label: "EMPRESA", val: "Poncho Capital" },
  { label: "FOCO", val: "Fintech · Producto" },
  { label: "STACK", val: "React · NestJS" },
];
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Full Stack Developer · Fintech · React · NestJS · GraphQL
          </div>
